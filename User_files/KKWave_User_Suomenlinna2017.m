...
Info.name='Suomenlinna2017'; % Project name
...
Forcing.wind_file=sprintf('%s/wind/Wind_Harmaja_1h_2017.asc',Info.folder); % Wind data
Forcing.ta_file=sprintf('%s/Ta/Ta_Harmaja_1h_2017.asc',Info.folder); % Air temperature data
Forcing.tw_file=sprintf('%s/Tw/Tw_Harmaja_1h_2017.asc',Info.folder); % Water temperature data



%% Boundary data
Info.BoundaryInput=sprintf('%s/bnd/BND_GoF2017.mat',Info.folder);
