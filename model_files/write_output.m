function write_output(fid,Site,Bnd,Nesting,Info,Hs,fp,Dw)
% function write_output(fid,Site,Bnd,Info,Hs,fp,Dw)
Fn=sprintf('wave_output/KKW_%s.mat',Info.name);

save(Fn,'Site','Bnd','Nesting','Hs','fp','Dw');
fprintf(fid,'### Saving wave >> %s\n', Fn);
fprintf('### Saving wave data >> %s\n', Fn);
